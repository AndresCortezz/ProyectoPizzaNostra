    ...
    <div class="row no-gutters d-flex">
        ...
        <div class="col-lg-4 d-flex ftco-animate">
            <div class="services-wrap d-flex">
                ...
                <div class="text p-4">
                    <h3 class="pizza-title">Italian Pizza</h3>
                    <p class="pizza-description">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
                    <p class="price"><span>$2.90</span> <a href="#" class="ml-2 btn btn-order">Order</a></p>
                </div>
            </div>
        </div>

        <!-- Repeat the pizza items similarly... -->
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <!-- Repeat for other pizza pricing entries... -->
        </div>
        ...
        <div class="col-md-6">
            ...
            <!-- Repeat for other pricing entries... -->
        </div>
    </div>
</div>
